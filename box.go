...
func New(options Options) (*Box, error) {
	...
	if experimentalOptions.Timeout != nil {
		...
		if experimentalOptions.Timeout.QUICTimeout != 0 {
			C.QUICTimeout = time.Duration(experimentalOptions.Timeout.QUICTimeout)
		}
		if experimentalOptions.Timeout.STUNTimeout != 0 {
			C.STUNTimeout = time.Duration(experimentalOptions.Timeout.STUNTimeout)
		}
