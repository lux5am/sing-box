...
func New(options Options) (*Box, error) {
	...
	if experimentalOptions.Timeout != nil {
		...
		if experimentalOptions.Timeout.HTTPTransportIdleConnTimeout != 0 {
			C.HTTPTransportIdleConnTimeout = time.Duration(experimentalOptions.Timeout.HTTPTransportIdleConnTimeout)
		}
		if experimentalOptions.Timeout.GRPCTransportCleanUpInterval != 0 {
			C.GRPCTransportCleanUpInterval = time.Duration(experimentalOptions.Timeout.GRPCTransportCleanUpInterval)
		}
