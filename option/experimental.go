...
type TimeoutOptions struct {
	...
	ICMPTimeout                  badoption.Duration `json:"icmp_timeout,omitempty"`
	DefaultDownloadInterval      badoption.Duration `json:"default_download_interval,omitempty"`
...
func (o *TimeoutOptions) Apply() {
	...
	if o.ICMPTimeout != 0 {
		C.ICMPTimeout = time.Duration(o.ICMPTimeout)
	}
	if o.DefaultDownloadInterval != 0 {
		C.DefaultDownloadInterval = time.Duration(o.DefaultDownloadInterval)
	}
